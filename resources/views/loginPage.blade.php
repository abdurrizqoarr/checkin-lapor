...
<body class="bg-sky-50 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full bg-white rounded-2xl shadow-lg p-6 mx-24 text-xl">
        ...
        <form method="POST">
            ...
            <button id="btnSubmit" type="submit"
                class="w-full py-3 mb-12 mt-2 bg-sky-600 hover:bg-sky-700 transition-colors text-white font-semibold rounded-xl shadow-md active:scale-[0.98]">
                Masuk
            </button>
        </form>
    </div>
